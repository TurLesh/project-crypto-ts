        ...
        <div className="list-info-wrapper">
            <div className="favourites-space">
                <InfoOutlinedIcon
                    ...
                    onMouseOver={favouritesInfoIconOnMouseOverHandler}
                    onMouseOut={favouritesInfoIconOnMouseOutHandler}
                />
            </div>
            <CSSTransition
                nodeRef={nodeRef}
                in={isHoveringFavouritesInfoIcon}
                timeout={200}
                classNames="display"
                unmountOnExit
            >
                <div ref={nodeRef} className={favouritesHelpPanelClassName}>
                    <div className="favourites-help-panel-triangle" />
                    <div className="favourites-help-panel-container">
                        <div className="favourites-help-panel-text">
                            {t('cryptocurrency-info-panel.favourites-help-panel.favourites-help-panel-text-1')}
                        </div>
                        <div className="favourites-help-panel-text">
                            {t('cryptocurrency-info-panel.favourites-help-panel.favourites-help-panel-text-2')}
                        </div>
                    </div>
                </div>
            </CSSTransition>
            ...
            <div className="change-percentage-info">
                <div className="1h-info change-time-info">
                    {t('cryptocurrency-info-panel.change-percentage-info.1h-info')}
                </div>
                <div className="24h-info change-time-info">
                    {t('cryptocurrency-info-panel.change-percentage-info.24h-info')}
                </div>
                <div className="7d-info change-time-info">
                    {t('cryptocurrency-info-panel.change-percentage-info.7d-info')}
                </div>
                <div className="30d-info change-time-info">
                    {t('cryptocurrency-info-panel.change-percentage-info.30d-info')}
                </div>
            </div>
            <div className="market-info-wrapper">
                <div className="market-cap-info market-info-item">
                    ...
                    <InfoOutlinedIcon
                        className="info-help-icon"
                        onMouseOver={marketCapInfoIconOnMouseOverHandler}
                        onMouseOut={marketCapInfoIconOnMouseOutHandler}
                    />
                    <CSSTransition
                        nodeRef={nodeRef}
                        in={isHoveringMarketCapInfoIcon}
                        timeout={200}
                        classNames="display"
                        unmountOnExit
                    >
                        <div ref={nodeRef} className={marketCapHelpPanelClassName}>
                            <div className="market-cap-help-panel-triangle" />
                            <div className="market-cap-help-panel-container">
                                <div className="market-cap-help-panel-text">
                                    {t(
                                        'cryptocurrency-info-panel.market-info.market-cap-help-panel.market-cap-help-panel-1'
                                    )}
                                </div>
                                <div className="market-cap-help-panel-text">
                                    {t(
                                        'cryptocurrency-info-panel.market-info.market-cap-help-panel.market-cap-help-panel-2'
                                    )}
                                </div>
                            </div>
                        </div>
                ...
                <div className="volume-24h-info market-info-item">
                    ...
                    <InfoOutlinedIcon
                        className="info-help-icon"
                        onMouseOver={volume24hInfoIconOnMouseOverHandler}
                        onMouseOut={volume24hInfoIconOnMouseOutHandler}
                    />
                    <CSSTransition
                        nodeRef={nodeRef}
                        in={isHoveringVolume24hInfoIcon}
                        timeout={200}
                        classNames="display"
                        unmountOnExit
                    >
                        <div ref={nodeRef} className={volume24hHelpPanelClassName}>
                            <div className="volume-24h-help-panel-triangle" />
                            <div className="volume-24h-help-panel-container">
                                <div className="volume-24h-help-panel-text">
                                    {t(
                                        'cryptocurrency-info-panel.market-info.volume-24h-help-panel.volume-24h-help-panel-1'
                                    )}
                                </div>
                            </div>
                        </div>
