...
const CryptocurrencySliderErrorCard: FC<ICryptocurrencySliderErrorCardData> = (props) => {
    ...
    const dataFromFuncs = CryptocurrencySliderCardFuncs({ isChange7dRising, name, priceHistory7dData, activeCurrency });
                ...
                <div className="top-info-container">
                    ...
                    <div className="currency-info-container">
                        <p className="currency-info">
                            {dataFromFuncs.currencyPrefix}
                            {currentPrice}
                        </p>
                    </div>
                </div>
                <div className="card-chart-container">
                    <ReactApexCharts series={dataFromFuncs.series} width={220} height={92} options={listChartOptions} />
                </div>
            </div>
